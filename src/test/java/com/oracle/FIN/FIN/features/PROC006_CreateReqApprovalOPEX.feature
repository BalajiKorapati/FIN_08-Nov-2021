#####################################################
#Script Name: PROC_06 Create req for Approval CC - check correct approvers
#Description/Action: Create req for Approval OPEX Project - check correct approvers
#Manual Test Case used: PROC_06 Create req for Approval OPEX Project - check correct approvers
...
#Feature File Name/s used:PROC006_CreateReqApprovalOPEX.feature
...
Feature: Procurement
  ...
  @PROC06
  Scenario Outline: PROC006_CreateReqApprovalOPEX
